        ...
        <div className="hero-content flex-col-reverse lg:flex-row">
          <div className="lg:mr-32 lg:px-24 px-2">
            ...
            <p className="py-6 text-justify">
              ...
              Caffeholic offers a vibrant community where you can: <p className="mt-5 mb-2 link-font text-xl">
              ...
              unique coffee recipes and brewing techniques.</p>
                ...
                <p className="mt-5 mb-2 link-font text-xl"><IoCheckmarkDoneSharp className="text-2xl inline text-amber-900 mr-1"></IoCheckmarkDoneSharp>Share your coffee
              experiences, photos, and reviews.</p>
              
               <p className="mt-5 mb-5 link-font text-xl"><IoCheckmarkDoneSharp className="text-2xl inline text-amber-900 mr-1"></IoCheckmarkDoneSharp>Connect with other coffee
              aficionados and exchange tips.</p> Join us and dive into the rich,
              aromatic universe of coffee, one post at a time!
            </p>
            <div className="flex justify-center">
              <button className="btn bg-amber-900 text-white text-2xl font-extralight link-font hover:bg-amber-950">Explore Coffeeposting!</button>
            </div>
          </div>
