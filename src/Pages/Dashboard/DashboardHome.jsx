...
const DashboardHome = () => {
  ...
  return (
   <div className="">
     ...
     <div className="my-5 md:my-0 md:mx-10  card  items-center rounded border-amber-900 border-2  lg:w-96 shadow-2xl  shadow-amber-900 ">
     <h1 className="text-center text-3xl font-bold text-amber-900 title-font my-1">Profile</h1>
        ...
        <button className="btn btn-sm text-white bg-amber-900">Edit Profile</button>
        </div>
        </div>
      </div>
     <div className="md:mx-2 card items-center  rounded border-amber-900 border-2  lg:w-96 shadow-2xl shadow-amber-900 ">
