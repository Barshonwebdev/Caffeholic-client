...
const AddPost = () => {
    ...
    const handleAddPost=(e)=>{
        ...
        const productData={poster,poster_email,coffee_name,description,photoURL,origin,short_recipe,personal_experience,type,color}
    ...
    return (
        <div>
            <Drawer></Drawer>
            <div>
      <h1 className="my-3 text-5xl text-amber-900 title-font text-center"> Make a Coffepost!</h1>
      <div className="hero  ">
        <div className="hero-content  flex-col lg:flex-row-reverse">
          <div className="card shrink-0 w-full max-w-sm shadow-amber-900 shadow-2xl bg-base-100">
            <form onSubmit={handleAddPost} className="card-body grid grid-cols-2 gap-x-10">
